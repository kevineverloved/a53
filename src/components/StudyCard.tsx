...
const StudyCard: React.FC<StudyCardProps> = ({ content, currentIndex, totalCards, onNext }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-4">
      ...
      <motion.div
        className="bg-white rounded-xl shadow-lg p-8 cursor-pointer min-h-[400px]"
      ...
      >
        <div className={`${isFlipped ? 'rotate-y-180' : ''} transform`}>
          {!isFlipped ? (
            ...
            <div className="space-y-4 rotate-y-180">
      ...
      <div className="mt-8 flex justify-between items-center">
        ...
        {currentIndex + 1 < totalCards ? (
          ...
          <Button onClick={onNext} variant="default">Start Quiz</Button>
        )}
      </div>
    </div>
  );
